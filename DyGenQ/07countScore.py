'''
python 07countScore.py \
    --json ./output/org/CQ_Answer_cmmlu0.0125.json
python 07countScore.py \
    --json ./output/org/CQ_Answer_CQ_format.json
    
python 07countScore.py \
    --json ./output/IFT/CQ_Answer_cmmlu0.0125.json
python 07countScoreCQ.py \
    --json ./output/IFT/CQ_Answer_CQ_format.json
-------
python 07countScore.py \
